...
data modify storage gb:dump PreWearingCheck set from entity @a[tag=gb.selected,limit=1] Inventory[{Slot:101b}]
...
execute if score .WearingCheck gb.runner matches 0 run function gb:zpriv/runner/if_loop