...
# segment existing?
execute if entity @e[type=marker,tag=gb.repeat_segment,limit=1,distance=..0.1] run scoreboard players set .destroyrepeat gb.misc 1
execute unless entity @e[type=marker,tag=gb.repeat_segment,limit=1,distance=..0.1] run scoreboard players set .destroyrepeat gb.misc 0
