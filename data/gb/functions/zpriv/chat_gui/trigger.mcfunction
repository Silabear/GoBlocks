...
execute if score @s gb.chatgui matches 22 run function gb:zpriv/chat_gui/if_player/miscellaneous
...
execute if score @s gb.chatgui matches 27..31 run function gb:zpriv/chat_gui/init_raycast
