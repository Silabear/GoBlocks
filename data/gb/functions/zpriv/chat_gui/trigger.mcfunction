...
execute if score @s gb.chatgui matches 64 run function gb:zpriv/chat_gui/function/clear
execute if score @s gb.chatgui matches 65 run function gb:zpriv/chat_gui/call_function/clear
