...
execute if score @s gb.call_function_stuff matches 2..27 if score .CallFunction gb.misc matches ..13 run function gb:zpriv/misc/trigger/add_call_char
execute if score @s gb.call_function_stuff matches 28 run data remove storage gb:call_function_edit Name[-1]
execute if score @s gb.call_function_stuff matches 2..28 run function gb:zpriv/chat_gui/call_function/main
