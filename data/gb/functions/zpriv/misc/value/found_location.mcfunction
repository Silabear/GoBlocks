...
# store location
summon minecraft:marker ~ ~ ~ {Tags:["gb.temp.pos"]}
execute store result score .x gb.misc run data get entity @e[type=minecraft:marker,tag=gb.temp.pos,limit=1,sort=nearest] Pos[0]
execute store result score .y gb.misc run data get entity @e[type=minecraft:marker,tag=gb.temp.pos,limit=1,sort=nearest] Pos[1]
execute store result score .z gb.misc run data get entity @e[type=minecraft:marker,tag=gb.temp.pos,limit=1,sort=nearest] Pos[2]
...
data modify block 0 0 0 Items[0].tag.GoBlocks.Data append from entity @e[type=minecraft:marker,tag=gb.temp.pos,limit=1,sort=nearest] Pos[0]
data modify block 0 0 0 Items[0].tag.GoBlocks.Data append from entity @e[type=minecraft:marker,tag=gb.temp.pos,limit=1,sort=nearest] Pos[1]
data modify block 0 0 0 Items[0].tag.GoBlocks.Data append from entity @e[type=minecraft:marker,tag=gb.temp.pos,limit=1,sort=nearest] Pos[2]
...
kill @e[type=minecraft:marker,tag=gb.temp.pos,limit=1,sort=nearest]
